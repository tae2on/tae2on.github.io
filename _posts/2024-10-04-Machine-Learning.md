...
- 표준화(Standardization): 각 변수의 평균이 0, 표준편차가 1이 됩니다.
...
- k 값이 작을 수록 복잡한 모델이 됩니다.

### **Decision Tree**
**max_depth**
- 트리의 최대 깊이 제한
- 이 값이 작을 수록 트리 깊이가 제한되어 모델이 단순해집니다.<br>

**min_samples_leaf**
- leaf가 되기 위한 최소한의 샘플 데이터 수
- 이 값이 클수록 모델이 단순해집니다.<br>
